...
const makeStills = (
  ...
  return make(
    ...
    outputFolder,
    '',
    '-vframes 1 -vf lutyuv=y=val*1.1,scale=iw*sar:ih',
    'png',
    num,
    min,
    max,
...
const makeGifs = (
  ...
  return make(
    ...
    outputFolder,
    '-t 2',
    `-v warning -filter_complex "[0:v] fps=12,scale=w=${width}:h=-1,split [a][b];[a] palettegen=stats_mode=single [p];[b][p] paletteuse=new=1"`,
    'gif',
    num,
    min,
    max
