...
class FilterCaptions {
  ...
  getCmdAnnotate(caption, width) {
    ...
    return `-pointsize ${fontSize} ${fontCmd} -size ${boxWidth}x -gravity South -fill white -background none -undercolor 'rgba(0, 0, 0, 0.5)' caption:"${cleanCaption}" -geometry +0+${padding}`;
  }
